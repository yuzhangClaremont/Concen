...
// drag a new viewController scene in storyboard library. Then build a new cocotouch file for it as UIViewControoler 30mins, and in storyboard IdentityInspector custom class choose class. Drag the arrow to the theme view.
// STACK them together
...
// click on theme scene, editor embed navigation controller
import UIKit
